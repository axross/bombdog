...
- SHOULD research external, current documentation when the issue depends on Next.js, React, Vercel, Playwright, Vitest, or Biome behavior, per [current-docs.md](../../development-guidelines/references/current-docs.md).
