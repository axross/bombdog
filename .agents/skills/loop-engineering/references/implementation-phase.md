...
- MUST review the whole diff through every matching lens in [Code Review Guideline](../../code-review-guideline/SKILL.md): correctness/bugs, maintainability, security, performance/reliability, UI/components, project structure, and test coverage.
