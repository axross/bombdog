...
A single new direct dependency can pull in dozens of transitive packages the author never inspects, any of which may already carry a known vulnerability.
