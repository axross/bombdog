...
description: The security and privacy review lens for code changes. Covers secrets/env vars, the framework's public/client-exposed env-var prefix (NEXT_PUBLIC_), input validation, access control, public exposure, output-encoding/injection in rendered untrusted content, SSRF/outbound fetch of user-controlled URLs, auth/session settings, and dependency supply-chain risk.
