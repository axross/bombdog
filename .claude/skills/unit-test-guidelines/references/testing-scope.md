...
- SHOULD consult the project's end-to-end testing guidelines and the project's React guidelines when the unit under discussion is a component rather than a pure helper.
