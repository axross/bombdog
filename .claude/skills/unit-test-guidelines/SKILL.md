...
when_to_use: Apply when writing, refactoring, reviewing, or running Vitest unit tests — including mocks/fakes, fixtures, schema tests, or behavior-focused assertion design.
