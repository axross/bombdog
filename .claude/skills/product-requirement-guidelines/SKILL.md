...
- UI component structure, CSS, and markup mechanics — [React Guidelines](../react-guidelines/SKILL.md). This skill owns only how to *describe* hierarchy, states, accessibility, and responsive intent in the spec (see below).
