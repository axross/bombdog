...
- UI component structure, CSS, and markup mechanics — the project's React guidelines. This skill owns only how to *describe* hierarchy, states, accessibility, and responsive intent in the spec (see below).
- Actual data flow implementation, routes, and module placement — the project's project-structure guidelines. This skill owns only how to *describe* system-design decisions in the spec (see below).
- Test coverage strategy — the project's end-to-end testing guidelines and the project's unit-test guidelines.
