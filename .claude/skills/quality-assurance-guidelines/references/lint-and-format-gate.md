...
Suppressions sets the required project default: flag a new Biome's inline suppression (with justification) directive that lacks an inline justification on the same line. The project rule is "explain why, not just what".
